            ...
            <div className="w-full lg:w-80 space-y-8">
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        <h4 className="text-[9px] text-brand-gold font-black uppercase tracking-widest">【關於費用】</h4>
                        <p className="text-[10px] text-slate-400 font-light leading-relaxed">
                            不是因為創作有價，而是因為時間有重量。<br/>
                            如果這個網站要存在、要被維護、要被好好對待，它必須被尊重。<br/>
                            你付費的不是功能，而是你願意為一首歌留下的時間。
                        </p>
                    </div>
                    <div className="space-y-2">
                        <h4 className="text-[9px] text-brand-gold font-black uppercase tracking-widest">【下載與權利說明】</h4>
                        <p className="text-[10px] text-slate-400 font-light leading-relaxed">
                            你可以下載你完成的歌詞影片。那是你陪這首歌走過的紀錄。<br/>
                            但下載，不代表任何著作權轉移。歌曲、歌詞、錄音的權利，仍屬原創作者所有。<br/>
                            這裡不是授權平台，也不提供轉售、商用或二次授權。<br/>
                            如果你理解這件事，你可以繼續。
                        </p>
                    </div>
                    <div className="space-y-2">
                        <h4 className="text-[9px] text-brand-gold font-black uppercase tracking-widest">【注意事項】</h4>
                        <p className="text-[10px] text-slate-400 font-light leading-relaxed">
                            以上方案都需要加入官方 LINE@ 進行後續服務與確認。
                        </p>
                    </div>
                </div>
            </div>
